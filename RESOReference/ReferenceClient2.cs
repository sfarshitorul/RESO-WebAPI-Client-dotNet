...
namespace RESOReference
{
    public partial class ReferenceClient : Form
    {
        ...
        private void loadscriptfile(string scriptfiledata)
        {
            ...
            if (string.IsNullOrEmpty(ResultsDirectory.Text))
            {
        ...
        {
                if (!Directory.Exists(clientsettings.GetSetting(settings.results_directory)))
                {
                    clientsettings.SetSetting(settings.results_directory, @"C:\results");
                    if (!Directory.Exists(clientsettings.GetSetting(settings.results_directory)))
                    {
        ...
        {
            if (!Directory.Exists(clientsettings.GetSetting(settings.log_directory)))
            {
                clientsettings.SetSetting(settings.log_directory, @"C:\logs");
                if (!Directory.Exists(clientsettings.GetSetting(settings.log_directory)))
                {
