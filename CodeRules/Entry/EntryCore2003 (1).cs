...
namespace ODataValidator.Rule
{
    ...
    public abstract class EntryCore2003 : ExtensionRule
    {
        ...
        private const string dsnsDefault = @"http://docs.oasis-open.org/odata/ns/edm/dataservices";
    }
    ...
    <element>
      <anyName>
        <except>
          ...
          <nsName ns=""http://docs.oasis-open.org/odata/ns/edm/dataservices/metadata""/>
        </except>
      </anyName>
      <ref name=""anyContent""/>
    </element>
