...
namespace ODataValidator.Rule.Helper
{
    ...
    public class EdmxHelper
    {
        ...
        public EdmxHelper(XElement metadta)
        {
            ...
            var csdlNodes = metadta.Descendants("{http://docs.oasis-open.org/odata/ns/edmx}DataServices").First().Elements();
        ...
        private EntityContainer GetDefaultEntityContainer()
        {
            foreach (var c in this.containers)
            {
                foreach (var a in c.MetadataProperties)
                {
                    ...
                    if (a.Name == "http://docs.oasis-open.org/odata/ns/edm/dataservices/metadata:IsDefaultEntityContainer")
                    {
