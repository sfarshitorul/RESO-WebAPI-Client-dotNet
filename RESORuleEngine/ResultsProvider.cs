...
{
    public class ResultsProvider : IResultProvider, ILogger
    {
        ...
        public List<TestResult> ResultsToSave
        {
            get { return resultsToSave; }
            set { resultsToSave = value; }
        }
        ...
        public List<ExtensionRuleResultDetail> Details
        {
            get { return details; }
            set { details = value; }
        }
        ...
        public ResultsProvider(Guid validationJobId, JobType jt = JobType.None)
        {
        ...
        public void Accept(ODataValidator.RuleEngine.TestResult result)
        {
            if (result == null)
            {
                return;
            ...
            testResult.Description = result.Description + "^" + result.TextInvolved;
        ...
        //    catch (Exception ex)
        //    {
        //        if (!ODataValidator.ODataValidator.RuleEngine.ExceptionHelper.IsCatchableExceptionType(ex))
        //        {
        //            throw;
        //        }
